...
const namespace = "workload-class-system"

// serviceAccountName created for the project
const serviceAccountName = "workload-class-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "workload-class-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "workload-class-metrics-binding"
