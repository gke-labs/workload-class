...
func PDBWithLease(pdb *policyv1.PodDisruptionBudget, wc *workloadsv1.WorkloadClass, pod *corev1.Pod, subject workloadsv1.Subject, namespaceDefault bool) error {
	if wc == nil {
