...
*/}}
{{- define "workload-class.fullname" -}}
...
*/}}
{{- define "workload-class.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "workload-class.resourceName" -}}
{{- $fullname := include "workload-class.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "workload-class.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "workload-class.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
